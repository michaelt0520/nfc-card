...
const routes = [
  ...
  { path: '/admin/dashboard', name: 'adminDashboard', component: lazyLoadRoute('AdminDashboard'), isPrivate: true },
  { path: '/company', name: 'company', component: lazyLoadRoute('Compnay'), isPrivate: true },
...
router.beforeEach((to, from, next) => {
  ...
  if (to.name === 'adminDashboard' && !isAuthenticated) next({ name: 'home' })

  if (to.name === 'company' && !(currentUser.role === 'Company Member' && currentUser.type === 'Buniness')) next({ name: 'home' })
