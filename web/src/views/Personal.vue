<template>
  <div class="text-gray-900 leading-normal tracking-wider bg-cover" style="background-image: url('https://source.unsplash.com/1L71sPT5XKc')">
    <div class="max-w-4xl flex items-center h-screen flex-wrap mx-auto">
      <div class="profile w-full lg:w-3/5 rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
        <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          <p class="pt-4">{{ card.User.email }}</p>
          <p class="pt-2">{{ card.User.Company.name }}</p>
          <p class="pt-2">Nghia</p>
        </div>
      </div>
