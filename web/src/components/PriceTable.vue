<template>
  <div id="price" class="antialiased max-w-6xl mx-auto my-12 px-8">
    <div class="relative block md:flex items-center">
      <div
        class="w-full md:w-1/2 relative z-1 bg-gray-100 rounded shadow-lg overflow-hidden"
      >
        <div
        ...
        <div class="block sm:flex md:block lg:flex items-center justify-center">
          <div
            class="mt-4 mb-8 sm:m-8 md:m-0 md:mt-4 md:mb-8 lg:m-8 text-center"
          >
            <div class="inline-flex items-center">
              <span class="text-3xl font-medium">$11.99</span>
            </div>
            <span class="block text-sm text-gray-600 mt-2">forever</span>
          </div>
        </div>
        <div class="flex justify-center mt-3">
          <ul>
            <li class="flex items-center">
              <div
                class="bg-green-200 rounded-full p-2 fill-current text-green-700"
              >
                <svg
            ...
            <li class="flex items-center mt-3">
              ...
              <span class="text-gray-700 text-lg ml-3"
                >Pay one time and use forever</span
              >
            </li>
            <li class="flex items-center mt-3">
              <div
              ...
              <span class="text-gray-700 text-lg ml-3"
                >Customize information</span
              >
            </li>
          </ul>
        </div>
        <a
          class="flex items-center justify-center bg-gray-200 hover:bg-gray-300 p-8 text-md font-semibold text-gray-800 uppercase mt-16"
          href="#join"
        >
      ...
      <div class="w-full md:w-1/2 relative z-0 px-8 md:px-0 md:py-16">
        ...
        >
          ...
          >
            ONETAP offers everything needed to run an online business at scale.
          ...
          <a
            class="flex items-center justify-center bg-blue-800 hover:bg-blue-700 p-8 text-md font-semibold text-gray-300 uppercase mt-8"
            href="#contact"
          >
