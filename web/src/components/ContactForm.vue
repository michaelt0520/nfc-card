<template>
  <div
    id="contact"
    class="relative flex items-top justify-center h-96 bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0"
  >
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      <div class="mt-8 overflow-hidden">
        <div class="grid grid-cols-1 md:grid-cols-2">
          ...
          <form @submit.prevent class="p-6 flex flex-col justify-center">
...
export default {
  ...
  methods: {
    ...
    onClickSendContact() {
      ...
      this.contactFullname = this.contactEmail = this.contactNumber = "";
