...
func (seed *Seed) LoadCompanySeed() {
	...
	companies := []models.Company{
		...
		{Name: "Toshiba Software Development", Address: "Ba Dinh, Ha Noi", Logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Toshiba_logo.svg/1280px-Toshiba_logo.svg.png", Website: "https://www.toshiba.com.vn/", Hotline: "1900 0902"},
	}
