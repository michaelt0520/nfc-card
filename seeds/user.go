...
func (seed *Seed) LoadUserSeed() {
	...
	users := []models.User{
		...
		{Name: "1TAP Second", Username: "1tap02", Email: "mt0520@1tap.vn", Password: "haituan", Address: "78 Wall St", PhoneNumber: "0909 991 009", Avatar: fmt.Sprintf("%s%s", os.Getenv("app_host"), DefaultAvatar), Type: models.Business, CompanyID: models.ConvertPointerUint(1), Role: models.UserCompanyManager},
		...
		{Name: "1TAP Fourth", Username: "1tap04", Email: "mt0522@1tap.vn", Password: "haituan", Address: "82 Wall St", PhoneNumber: "0909 993 009", Avatar: fmt.Sprintf("%s%s", os.Getenv("app_host"), DefaultAvatar), Type: models.Business, CompanyID: models.ConvertPointerUint(2), Role: models.UserCompanyManager},
		...
		{Name: "1TAP Seventh", Username: "1tap07", Email: "mt0525@1tap.vn", Password: "haituan", Address: "88 Wall St", PhoneNumber: "0909 996 009", Avatar: fmt.Sprintf("%s%s", os.Getenv("app_host"), DefaultAvatar), Type: models.Business, CompanyID: models.ConvertPointerUint(3), Role: models.UserCompanyManager},
